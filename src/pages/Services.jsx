        ...
        <div className='container'>
          <div className='services-hero-content'>
            ...
            <p className='page-description'>
              From ideation to deployment, we provide end-to-end software
          ...
          <div className='process-steps'>
            <div className='process-step'>
              ...
              <p className='step-description'>
                ...
                requirements through in-depth consultations and analysis.
              </p>
            </div>
            <div className='process-step'>
              ...
              <p className='step-description'>
                Our team creates a detailed project roadmap, including
            ...
            <div className='process-step'>
              ...
              <p className='step-description'>
                Using agile methodologies, we build your solution iteratively
                with regular check-ins and demonstrations.
              </p>
            </div>
            <div className='process-step'>
              ...
              <p className='step-description'>
                After thorough testing and quality assurance, we deploy your
                solution and provide ongoing support.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className='cta-content'>
            ...
            <div className='cta-buttons'>
              ...
              <a
                ...
                className='btn btn-secondary btn-large cta-btn-light'
              >
                Email Us Directly
              </a>
            </div>
